...
static const struct RecordDescriptor MER_RR__2P_GADS_sfgi_meris_rec_data[] = {
    ...
    {"off_cloud_top_press", e_tid_float, "hPa", 4, "1", "offset - Cloud Top Pressure"},
    {"gain_set", e_tid_uchar, NULL, 1, "5*16", "Gain setting"},
    {"sampl_rate", e_tid_ulong, "(10-6) s", 4, "1", "sampling rate"},
    {"sun_spec_flux", e_tid_float, "LU", 4, "15", "Sun Spectral Flux (for bands 1-15)"},
...
static const struct RecordDescriptor ATS_AR__2P_MDSR_lr_large_aatsr_rec_data[] = {
    ...
    {"lat", e_tid_long, "(1e-6) degrees", 4, "1", "Latitude of  cell"},
    {"lon", e_tid_long, "(1e-6) degrees", 4, "1", "Longitude of  cell"},
    ...
    {"lat_corr_nad", e_tid_long, "(1e-6) degrees", 4, "1", "Topographic latitude correction, nadir view"},
    {"long_corr_nad", e_tid_long, "(1e-6) degrees", 4, "1", "Topographic longitude correction, nadir view"},
    {"sa_12bt_clr_nad", e_tid_long, "K/1000", 4, "1", "Spatially averaged 12 micron BT of all clear pixels (nadir view)"},
    {"sd_12bt_clr_nad", e_tid_long, "K/1000", 4, "1", "Standard deviation of above"},
    {"sa_11bt_clr_nad", e_tid_long, "K/1000", 4, "1", "Spatially averaged 11 micron BT of all clear pixels (nadir view)"},
    {"sd_11bt_clr_nad", e_tid_long, "K/1000", 4, "1", "Standard deviation of above"},
    {"sa_37bt_clr_nad", e_tid_long, "K/1000", 4, "1", "Spatially averaged 3.7 micron BT of all clear pixels (nadir view)"},
    {"sd_37bt_clr_nad", e_tid_long, "%/1000", 4, "1", "Standard deviation of above"},
    ...
    {"sa_12bt_cl_nad", e_tid_long, "K/1000", 4, "1", "Spatially averaged 12 micron BT of all cloudy pixels (nadir view)"},
    {"sd_12bt_cl_nad", e_tid_long, "K/1000", 4, "1", "Standard deviation of above"},
    {"sa_11bt_cl_nad", e_tid_long, "K/1000", 4, "1", "Spatially averaged 11 micron BT of all cloudy pixels (nadir view)"},
    {"sd_11bt_cl_nad", e_tid_long, "K/1000", 4, "1", "Standard deviation of above"},
    {"sa_37bt_cl_nad", e_tid_long, "K/1000", 4, "1", "Spatially averaged 3.7 micron BT of all cloudy pixels (nadir view)"},
    {"sd_37bt_cl_nad", e_tid_long, "%/1000", 4, "1", "Standard deviation of above"},
    ...
    {"lat_corr_for", e_tid_long, "(1e-6) degrees", 4, "1", "Topographic latitude correction, forward view"},
    {"long_corr_for", e_tid_long, "(1e-6) degrees", 4, "1", "Topographic longitude correction, forward view"},
    {"sa_12bt_clr_for", e_tid_long, "K/1000", 4, "1", "Spatially averaged 12 micron BT of all clear pixels (forward view)"},
    {"sd_12bt_clr_for", e_tid_long, "K/1000", 4, "1", "Standard deviation of above"},
    {"sa_11bt_clr_for", e_tid_long, "K/1000", 4, "1", "Spatially averaged 11 micron BT of all clear pixels (forward view)"},
    {"sd_11bt_clr_for", e_tid_long, "K/1000", 4, "1", "Standard deviation of above"},
    {"sa_37bt_clr_for", e_tid_long, "K/1000", 4, "1", "Spatially averaged 3.7 micron BT of all clear pixels (forward view)"},
    {"sd_37bt_clr_for", e_tid_long, "K/1000", 4, "1", "Standard deviation of above"},
    ...
    {"sa_12bt_cl_for", e_tid_long, "K/1000", 4, "1", "Spatially averaged 12 micron BT of all cloudy pixels (forward view)"},
    {"sd_12bt_cl_for", e_tid_long, "K/1000", 4, "1", "Standard deviation of above"},
    {"sa_11bt_cl_for", e_tid_long, "K/1000", 4, "1", "Spatially averaged 11 micron BT of all cloudy pixels (forward view)"},
    {"sd_11bt_cl_for", e_tid_long, "K/1000", 4, "1", "Standard deviation of above"},
    {"sa_37bt_cl_for", e_tid_long, "K/1000", 4, "1", "Spatially averaged 3.7 micron BT of all cloudy pixels (forward view)"},
    {"sd_37bt_cl_for", e_tid_long, "K/1000", 4, "1", "Standard deviation of above"},
...
static const struct RecordDescriptor ATS_AR__2P_MDSR_sr_large_aatsr_rec_data[] = {
    ...
    {"sd_11bt_clr_nad", e_tid_long, "K/1000", 4, "1", "Standard deviation of above"},
    {"sa_37bt_clr_nad", e_tid_long, "K/1000", 4, "1", "Spatially averaged 3.7 micron BT of all clear pixels (nadir view)"},
    {"sd_37bt_clr_nad", e_tid_long, "K/1000", 4, "1", "Standard deviation of above"},
    {"sa_16toa_clr_nad", e_tid_short, "%/100", 2, "1", "Spatially averaged 1.6 micron TOA reflectance of all clear pixels (nadir view)"},
    {"sd_16toa_clr_nad", e_tid_short, "%/100", 2, "1", "Standard deviation of above"},
    {"sa_87toa_clr_nad", e_tid_short, "%/100", 2, "1", "Spatially averaged 0.87 micron TOA reflectance of all clear pixels (nadir view)"},
    {"sd_87toa_clr_nad", e_tid_short, "%/100", 2, "1", "Standard deviation of above"},
    ...
    {"sd_11bt_cl_nad", e_tid_long, "K/1000", 4, "1", "Standard deviation of above"},
    {"sa_37bt_cl_nad", e_tid_long, "K/1000", 4, "1", "Spatially averaged 3.7 micron BT of all cloudy pixels (nadir view)"},
    {"sd_37bt_cl_nad", e_tid_long, "K/1000", 4, "1", "Standard deviation of above"},
    {"sa_16toa_cl_nad", e_tid_short, "%/100", 2, "1", "Spatially averaged 1.6 micron TOA reflectance of all cloudy pixels (nadir view)"},
    {"sd_16toa_cl_nad", e_tid_short, "%/100", 2, "1", "Standard deviation of above"},
    {"sa_87toa_cl_nad", e_tid_short, "%/100", 2, "1", "Spatially averaged 0.87 micron TOA reflectance of all cloudy pixels (nadir view)"},
    {"sd_87toa_cl_nad", e_tid_short, "%/100", 2, "1", "Standard deviation of above"},
...
static const struct RecordDescriptor ATS_MET_2P_meteo_user_prod_aatsr_rec_data[] = {
    ...
    {"spare_1", e_tid_spare, NULL, 3, "1", "Spare"},
    {"lat", e_tid_long, "(1e-6) degrees", 4, "1", "Latitude of 10 arcmin cell"},
    {"lon", e_tid_long, "(1e-6) degrees", 4, "1", "Longitude of 10 arcmin cell"},
    {"sa_12bt_clr_nad", e_tid_long, "K/1000", 4, "1", "Nadir spatially averaged 12 micron BT of all clear pixels 10 arcmin cells"},
    {"sa_11bt_clr_nad", e_tid_long, "K/1000", 4, "1", "Nadir spatially averaged 11 micron BT of all clear pixels in 10 arcmin cells"},
    {"sa_37bt_clr_nad", e_tid_long, "K/1000", 4, "1", "Nadir spatially averaged 3.7 micron BT of all clear pixels in 10 arcmin cells"},
    {"sa_12bt_clr_for", e_tid_long, "K/1000", 4, "1", "Forward spatially averaged 12 micron BT of all clear pixels in 10 arcmin cells"},
    {"sa_11bt_clr_for", e_tid_long, "K/1000", 4, "1", "Forward spatially averaged 11 micron BT of all clear pixels in 10 arcmin cells"},
    {"sa_37bt_clr_for", e_tid_long, "K/1000", 4, "1", "Forward spatially averaged 3.7 micron BT of all clear pixels in 10 arcmin cells"},
...
static const struct RecordDescriptor ATS_NR__2P_MDSR_dp_aatsr_rec_data[] = {
    ...
    {"quality_flag", e_tid_uchar, "flag", 1, "1", "Quality Indicator (-1 for blank MDSR, 0 otherwise)"},
    {"spare_1", e_tid_spare, NULL, 3, "1", "Spare"},
    {"img_scan_y", e_tid_long, "m", 4, "1", "image scan y coordinate"},
...
static const struct RecordDescriptor ATS_TOA_1P_ADSR_loc_aatsr_rec_data[] = {
    ...
    {"spare_1", e_tid_spare, NULL, 3, "1", "Spare"},
    {"img_scan_y", e_tid_long, "m", 4, "1", "image scan y coordinate"},
    {"tie_pt_lat", e_tid_long, "(1e-6) degrees", 4, "23", "tie point latitudes"},
    {"tie_pt_long", e_tid_long, "(1e-6) degrees", 4, "23", "tie point longitudes"},
    {"lat_corr_nadv", e_tid_long, "(1e-6) degrees", 4, "23", "latitude corrections, nadir view"},
    {"long_corr_nadv", e_tid_long, "(1e-6) degrees", 4, "23", "longitude corrections, nadir view"},
    {"lat_corr_forv", e_tid_long, "(1e-6) degrees", 4, "23", "latitude corrections, forward view"},
    {"long_corr_forv", e_tid_long, "(1e-6) degrees", 4, "23", "longitude corrections, forward view"},
...
static const struct RecordDescriptor ATS_TOA_1P_ADSR_sa_aatsr_rec_data[] = {
    ...
    {"spare_1", e_tid_spare, NULL, 3, "1", "Spare"},
    {"img_scan_y", e_tid_long, "m", 4, "1", "image scan y coordinate"},
    {"tie_pt_sol_elev", e_tid_long, "mdeg", 4, "11", "tie point solar elevation"},
    {"tie_pt_sat_elev_nad", e_tid_long, "mdeg", 4, "11", "tie point satellite elevation nadir"},
    {"tie_pt_sol_az", e_tid_long, "mdeg", 4, "11", "tie point solar azimuth"},
    {"tie_pt_sat_azi", e_tid_long, "mdeg", 4, "11", "tie point satellite azimuth"},
...
static const struct RecordDescriptor ATS_TOA_1P_ADSR_scan_aatsr_rec_data[] = {
    ...
    {"tie_pix_x", e_tid_long, "m", 4, "99", "tie pixel x coordinate"},
    {"tie_pix_y", e_tid_long, "m", 4, "99", "tie pixel y coordinate"},
    {"spare_2", e_tid_spare, NULL, 20, "1", "spare"}
};
...
static const struct RecordDescriptor ASAR_Geo_Grid_ADSR_asar_rec_data[] = {
    ...
    {"attach_flag", e_tid_uchar, "flag", 1, "1", "Attachment Flag (set to 1 if all MDSRs corresponding to this ADSR are blank, set to zero otherwise)."},
    {"line_num", e_tid_ulong, NULL, 4, "1", "Range line number corresponding to the first line of the granule"},
    {"num_lines", e_tid_ulong, "lines", 4, "1", "Number of output lines in this granule"},
    ...
    {"first_line_tie_points.samp_numbers", e_tid_ulong, NULL, 4, "11", "Range sample number. Gives the range location of the grid points. First range sample is 1, last is M. Zero filled samples are included."},
    ...
    {"first_line_tie_points.lats", e_tid_long, "(1e-6) degrees", 4, "11", "geodetic latitude (positive north)"},
    {"first_line_tie_points.longs", e_tid_long, "(1e-6) degrees", 4, "11", "geodetic longitude (positive east)"},
    ...
    {"last_line_tie_points.samp_numbers", e_tid_ulong, NULL, 4, "11", "Range sample number. Gives the range location of the grid points. First range sample is 1, last is M."},
    ...
    {"last_line_tie_points.lats", e_tid_long, "(1e-6) degrees", 4, "11", "geodetic latitude (positive north)"},
    {"last_line_tie_points.longs", e_tid_long, "(1e-6) degrees", 4, "11", "geodetic longitude (positive east)"},
...
static const struct RecordDescriptor ASAR_Image_MDSR_BP_asar_rec_data[] = {
    ...
    {"quality_flag", e_tid_uchar, "flag", 1, "1", "Quality Indicator (-1 for blank MDSR, 0 otherwise)"},
    {"line_num", e_tid_ulong, NULL, 4, "1", "Range line number. Numbered sequentially, for each product (or slice) first range line in MDS is 1"},
...
static const struct RecordDescriptor ASAR_Main_ADSR_asar_rec_data[] = {
    ...
    {"num_output_lines", e_tid_ulong, "lines", 4, "1", "Number of output range lines in the image described by this ADS"},
    {"num_samples_per_line", e_tid_ulong, "samples", 4, "1", "Number of samples per output range line (includes zero filled samples)"},
    ...
    {"raw_data_analysis.1.num_gaps", e_tid_ulong, "gaps", 4, "1", "Number of input data gaps (a gap is defined as a predetermined number of range lines) (record 1)"},
    {"raw_data_analysis.1.num_missing_lines", e_tid_ulong, "lines", 4, "1", "Number of missing lines, excluding data gaps (record 1)"},
    {"raw_data_analysis.1.range_samp_skip", e_tid_ulong, "samples", 4, "1", "Range sample skipping factor for raw data analysis (record 1)"},
    {"raw_data_analysis.1.range_lines_skip", e_tid_ulong, "lines", 4, "1", "Range lines skipping factor for raw data analysis (record 1)"},
    ...
    {"raw_data_analysis.2.num_gaps", e_tid_ulong, "gaps", 4, "1", "Number of input data gaps (a gap is defined as a predetermined number of range lines) (record 2)"},
    {"raw_data_analysis.2.num_missing_lines", e_tid_ulong, "lines", 4, "1", "Number of missing lines, excluding data gaps (record 2)"},
    {"raw_data_analysis.2.range_samp_skip", e_tid_ulong, "samples", 4, "1", "Range sample skipping factor for raw data analysis (record 2)"},
    {"raw_data_analysis.2.range_lines_skip", e_tid_ulong, "lines", 4, "1", "Range lines skipping factor for raw data analysis (record 2)"},
    ...
    {"start_time.1.first_obt", e_tid_ulong, NULL, 4, "2", "On-board binary time of first input line processed. LSB accurate to 15.26 us. (Contained in two long integers) (record 1)"},
    ...
    {"start_time.2.first_obt", e_tid_ulong, NULL, 4, "2", "On-board binary time of first input line processed. LSB accurate to 15.26 us. (Contained in two long integers) (record 2)"},
    ...
    {"error_counters.num_err_swst", e_tid_ulong, NULL, 4, "1", "Number of errors detected in Sampling Window start time field."},
    {"error_counters.num_err_pri", e_tid_ulong, NULL, 4, "1", "Number of errors detected in PRI code field"},
    {"error_counters.num_err_tx_pulse_len", e_tid_ulong, NULL, 4, "1", "Number of errors detected in Tx pulse length field"},
    {"error_counters.num_err_tx_pulse_bw", e_tid_ulong, NULL, 4, "1", "Number of errors detected in Tx pulse bandwidth field."},
    {"error_counters.num_err_echo_win_len", e_tid_ulong, NULL, 4, "1", "Number of errors detected in Echo Window Length field."},
    {"error_counters.num_err_up", e_tid_ulong, NULL, 4, "1", "Number of errors detected in Upconverter Level field."},
    {"error_counters.num_err_down", e_tid_ulong, NULL, 4, "1", "Number of errors detected in Downconverter Level field."},
    {"error_counters.num_err_resamp", e_tid_ulong, NULL, 4, "1", "Number of errors detected in Resampling factor for echo data field."},
    {"error_counters.num_err_beam_adj", e_tid_ulong, NULL, 4, "1", "Number of errors detected in Beam adjustment delta field."},
    {"error_counters.num_err_beam_set_num", e_tid_ulong, NULL, 4, "1", "Number of errors detected in Antenna Beam Set Number field."},
    ...
    {"image_parameters.swst_changes", e_tid_ulong, NULL, 4, "5", "Number of Sample Window Start Time changes within a beam"},
    ...
    {"first_proc_range_samp", e_tid_ulong, "samples", 4, "1", "First processed input range sample, first sample is 1"},
    ...
    {"num_lines_proc", e_tid_ulong, "lines", 4, "1", "Number of input lines processed"},
    ...
    {"noise_estimation.num_noise_lines", e_tid_ulong, NULL, 4, "5", "Number of noise lines used to calculate factors"},
    ...
    {"beam_merge_sl_range", e_tid_ulong, NULL, 4, "4", "Number of slant range samples in beam merging, one value per mergae rregion (1-2, 2-3, 3-4, 4-5)"},
    ...
    {"lines_per_burst", e_tid_ulong, "lines", 4, "5", "Number of lines per burst for this image. 5 values for beams SS1 to SS5 in WS and GM modes. Two values for AP mode, all others set to zero."},
    ...
    {"orbit_state_vectors.1.x_pos_1", e_tid_long, "10 -2m", 4, "1", "X position in Earth fixed reference frame (record 1)"},
    {"orbit_state_vectors.1.y_pos_1", e_tid_long, "10 -2m", 4, "1", "Y position in Earth fixed reference frame (record 1)"},
    {"orbit_state_vectors.1.z_pos_1", e_tid_long, "10 -2m", 4, "1", "Z position in Earth fixed reference frame (record 1)"},
    {"orbit_state_vectors.1.x_vel_1", e_tid_long, "10 -5m/s", 4, "1", "X velocity relative to Earth fixed reference frame (record 1)"},
    {"orbit_state_vectors.1.y_vel_1", e_tid_long, "10 -5m/s", 4, "1", "Y velocity relative to Earth fixed reference frame (record 1)"},
    {"orbit_state_vectors.1.z_vel_1", e_tid_long, "10 -5m/s", 4, "1", "Z velocity relative to Earth fixed reference frame (record 1)"},
    {"orbit_state_vectors.2.state_vect_time_1", e_tid_time, "MJD", 12, "1", "Time of state vector (record 2)"},
    {"orbit_state_vectors.2.x_pos_1", e_tid_long, "10 -2m", 4, "1", "X position in Earth fixed reference frame (record 2)"},
    {"orbit_state_vectors.2.y_pos_1", e_tid_long, "10 -2m", 4, "1", "Y position in Earth fixed reference frame (record 2)"},
    {"orbit_state_vectors.2.z_pos_1", e_tid_long, "10 -2m", 4, "1", "Z position in Earth fixed reference frame (record 2)"},
    {"orbit_state_vectors.2.x_vel_1", e_tid_long, "10 -5m/s", 4, "1", "X velocity relative to Earth fixed reference frame (record 2)"},
    {"orbit_state_vectors.2.y_vel_1", e_tid_long, "10 -5m/s", 4, "1", "Y velocity relative to Earth fixed reference frame (record 2)"},
    {"orbit_state_vectors.2.z_vel_1", e_tid_long, "10 -5m/s", 4, "1", "Z velocity relative to Earth fixed reference frame (record 2)"},
    {"orbit_state_vectors.3.state_vect_time_1", e_tid_time, "MJD", 12, "1", "Time of state vector (record 3)"},
    {"orbit_state_vectors.3.x_pos_1", e_tid_long, "10 -2m", 4, "1", "X position in Earth fixed reference frame (record 3)"},
    {"orbit_state_vectors.3.y_pos_1", e_tid_long, "10 -2m", 4, "1", "Y position in Earth fixed reference frame (record 3)"},
    {"orbit_state_vectors.3.z_pos_1", e_tid_long, "10 -2m", 4, "1", "Z position in Earth fixed reference frame (record 3)"},
    {"orbit_state_vectors.3.x_vel_1", e_tid_long, "10 -5m/s", 4, "1", "X velocity relative to Earth fixed reference frame (record 3)"},
    {"orbit_state_vectors.3.y_vel_1", e_tid_long, "10 -5m/s", 4, "1", "Y velocity relative to Earth fixed reference frame (record 3)"},
    {"orbit_state_vectors.3.z_vel_1", e_tid_long, "10 -5m/s", 4, "1", "Z velocity relative to Earth fixed reference frame (record 3)"},
    {"orbit_state_vectors.4.state_vect_time_1", e_tid_time, "MJD", 12, "1", "Time of state vector (record 4)"},
    {"orbit_state_vectors.4.x_pos_1", e_tid_long, "10 -2m", 4, "1", "X position in Earth fixed reference frame (record 4)"},
    {"orbit_state_vectors.4.y_pos_1", e_tid_long, "10 -2m", 4, "1", "Y position in Earth fixed reference frame (record 4)"},
    {"orbit_state_vectors.4.z_pos_1", e_tid_long, "10 -2m", 4, "1", "Z position in Earth fixed reference frame (record 4)"},
    {"orbit_state_vectors.4.x_vel_1", e_tid_long, "10 -5m/s", 4, "1", "X velocity relative to Earth fixed reference frame (record 4)"},
    {"orbit_state_vectors.4.y_vel_1", e_tid_long, "10 -5m/s", 4, "1", "Y velocity relative to Earth fixed reference frame (record 4)"},
    {"orbit_state_vectors.4.z_vel_1", e_tid_long, "10 -5m/s", 4, "1", "Z velocity relative to Earth fixed reference frame (record 4)"},
    {"orbit_state_vectors.5.state_vect_time_1", e_tid_time, "MJD", 12, "1", "Time of state vector (record 5)"},
    {"orbit_state_vectors.5.x_pos_1", e_tid_long, "10 -2m", 4, "1", "X position in Earth fixed reference frame (record 5)"},
    {"orbit_state_vectors.5.y_pos_1", e_tid_long, "10 -2m", 4, "1", "Y position in Earth fixed reference frame (record 5)"},
    {"orbit_state_vectors.5.z_pos_1", e_tid_long, "10 -2m", 4, "1", "Z position in Earth fixed reference frame (record 5)"},
    {"orbit_state_vectors.5.x_vel_1", e_tid_long, "10 -5m/s", 4, "1", "X velocity relative to Earth fixed reference frame (record 5)"},
    {"orbit_state_vectors.5.y_vel_1", e_tid_long, "10 -5m/s", 4, "1", "Y velocity relative to Earth fixed reference frame (record 5)"},
    {"orbit_state_vectors.5.z_vel_1", e_tid_long, "10 -5m/s", 4, "1", "Z velocity relative to Earth fixed reference frame (record 5)"},
...
static const struct RecordDescriptor ASAR_Map_GADS_asar_rec_data[] = {
    ...
    {"samples", e_tid_ulong, NULL, 4, "1", "Number of samples per line"},
    {"lines", e_tid_ulong, NULL, 4, "1", "Number of lines"},
    ...
    {"utm_center_long", e_tid_long, "(1e-6) degrees", 4, "1", "Projection centre longitude, deg"},
    {"utm_center_lat", e_tid_long, "(1e-6) degrees", 4, "1", "Projection centre latitude, deg"},
    ...
    {"ups_center_long", e_tid_long, "(1e-6) degrees", 4, "1", "Projection centre longitude, deg"},
    {"ups_center_lat", e_tid_long, "(1e-6) degrees", 4, "1", "Projection centre latitude, deg"},
    ...
    {"center_long", e_tid_long, "(1e-6) degrees", 4, "1", "Projection centre longitude, deg"},
    {"center_lat", e_tid_long, "(1e-6) degrees", 4, "1", "Projection centre latitude, deg"},
    ...
    {"position_lat_long.tl_lat", e_tid_long, "(1e-6) degrees", 4, "1", "Top left corner latitude"},
    {"position_lat_long.tl_long", e_tid_long, "(1e-6) degrees", 4, "1", "Top left corner longitude"},
    {"position_lat_long.tr_lat", e_tid_long, "(1e-6) degrees", 4, "1", "Top right corner latitude"},
    {"position_lat_long.tr_long", e_tid_long, "(1e-6) degrees", 4, "1", "Top right corner longitude"},
    {"position_lat_long.br_lat", e_tid_long, "(1e-6) degrees", 4, "1", "Bottom right corner latitude"},
    {"position_lat_long.br_long", e_tid_long, "(1e-6) degrees", 4, "1", "Bottom right corner longitude"},
    {"position_lat_long.bl_lat", e_tid_long, "(1e-6) degrees", 4, "1", "Bottom left corner latitude"},
    {"position_lat_long.bl_long", e_tid_long, "(1e-6) degrees", 4, "1", "Bottom left corner longitude"},
...
static const struct RecordDescriptor ASAR_Ocean_Spectra_MDSR_asar_rec_data[] = {
    ...
    {"confidence", e_tid_long, NULL, 4, "1", "Confidence measure of the swell inversion"},
...
static const struct RecordDescriptor ASAR_SQ1_Image_ADSR_asar_rec_data[] = {
    ...
    {"lines_per_gaps", e_tid_ulong, "lines", 4, "1", "Number of missing lines which constitute a gap"},
    ...
    {"tot_errors", e_tid_ulong, NULL, 4, "1", "Total number of errors detected in ISP headers"},
...
static const struct RecordDescriptor ASAR_Wave_Geolocation_ADSR_asar_rec_data[] = {
    ...
    {"center_lat", e_tid_long, "(1e-6) degrees", 4, "1", "Geodetic latitude of center point (positive north) This is the center point of the wave cell. It is calculated after the cross spectra processing, and thus may differ from the center sample latitude of the SLC imagette if slant range to ground range conve"},
    {"center_long", e_tid_long, "(1e-6) degrees", 4, "1", "Geodetic longitude of center point (positive east)This is the center point of the wave cell. It is calculated after the cross spectra processing, and thus may differ from the center sample latitude of the SLC imagette if slant range to ground range conver"},
    {"spare_1", e_tid_spare, NULL, 4, "1", "Spare"}
};
...
static const struct RecordDescriptor ASAR_Wave_Param_ADSR_asar_rec_data[] = {
    ...
    {"raw_data_analysis.2.used_quad", e_tid_float, NULL, 4, "1", "I/Q quadrature departure used for correction(may be different from measured value) (record 2)"},
    {"spare_3", e_tid_spare, NULL, 32, "1", "Spare"},
    {"start_time.1.first_obt", e_tid_ulong, NULL, 4, "2", "On-board binary time of first input line processedLSB accurate to 15.26 ms. (Contained in two long integers) (record 1)"},
    ...
    {"start_time.2.first_obt", e_tid_ulong, NULL, 4, "2", "On-board binary time of first input line processedLSB accurate to 15.26 ms. (Contained in two long integers) (record 2)"},
    ...
    {"spare_12", e_tid_spare, NULL, 64, "1", "Spare"},
    {"beam_overlap", e_tid_ulong, NULL, 4, "4", "Number of slant range samples in beam overlap(1-2, 2-3, 3-4, 4-5)"},
    {"lines_per_burst", e_tid_ulong, "lines", 4, "5", "Number of lines per burst for this image 5 values for beams SS1 to SS5 in WS and GM modes.One value for AP mode, all others set to zero."},
    ...
    {"first_line_tie_points.range_samp_nums_first", e_tid_ulong, NULL, 4, "3", "Range sample number Gives the range location of the grid points. First range sample is 1,  is M (includes zero filled samples)"},
    ...
    {"first_line_tie_points.lats_first", e_tid_long, "(1e-6) degrees", 4, "3", "geodetic latitude of range sample (positive north)"},
    {"first_line_tie_points.longs_first", e_tid_long, "(1e-6) degrees", 4, "3", "geodetic longitude of range sample (positive east)"},
    {"mid_line_time", e_tid_time, "MJD", 12, "1", "Zero Doppler Time at centre line of imagette"},
    {"mid_range_line_nums", e_tid_ulong, NULL, 4, "1", "Range line number of the center range line"},
    {"mid_line_tie_points.range_samp_nums_mid", e_tid_ulong, NULL, 4, "3", "Range sample number Gives the range location of the grid points. First range sample is 1,  is M (includes zero filled samples)"},
    ...
    {"mid_line_tie_points.lats_mid", e_tid_long, "(1e-6) degrees", 4, "3", "geodetic latitude of range sample (positive north)"},
    {"mid_line_tie_points.longs_mid", e_tid_long, "(1e-6) degrees", 4, "3", "geodetic longitude of range sample (positive east)"},
    {"last_line_time", e_tid_time, "MJD", 12, "1", "Zero Doppler Time at last line of imagette"},
    {"last_line_num", e_tid_ulong, NULL, 4, "1", "Range line number of the last range line"},
    {"last_line_tie_points.range_samp_nums_last", e_tid_ulong, NULL, 4, "3", "Range sample number Gives the range location of the grid points. First range sample is 1,  is M (includes zero filled samples)"},
    ...
    {"last_line_tie_points.lats_last", e_tid_long, "(1e-6) degrees", 4, "3", "geodetic latitude of range sample (positive north)"},
    {"last_line_tie_points.longs_last", e_tid_long, "(1e-6) degrees", 4, "3", "geodetic longitude of range sample (positive east)"},
...
static const struct RecordDescriptor ASAR_Wave_SQ_ADSR_asar_rec_data[] = {
    ...
    {"az_cutoff_iterations_thresh", e_tid_ulong, NULL, 4, "1", "Azimuth cut-off Iteration count overflow threshold"},
...
static const struct RecordDescriptor ASA_CON_AX_GADS_asar_rec_data[] = {
    ...
    {"dsr_length", e_tid_ulong, "bytes", 4, "1", "Length of this DSR in bytes"},
    {"thresh_chirp_broadening", e_tid_float, "%", 4, "1", "Threshold for setting the chirp quality flag. Maximum percentage broadening permitted in cross-correlation pulse width compared to theoretical width."},
    {"thresh_chirp_sidelobe", e_tid_float, "dB", 4, "1", "Threshold for setting the chirp quality flag - First sidelobe of the chirp cross correlation function"},
    {"thresh_chirp_islr", e_tid_float, "dB", 4, "1", "Threshold for setting the chirp quality flag - ISLR of the chirp cross correlation function"},
    ...
    {"spare_1", e_tid_spare, NULL, 64, "1", "Spare"},
    {"lines_per_gap", e_tid_ulong, "lines", 4, "1", "Number of missing lines which constitute a gap"},
...
static const struct BandDescriptor MER_FR__2P_band_data[] = {
    ...
    {"l2_flags", "Flags.3", e_smod_3TOI, e_tid_ulong, -1, e_smid_non, NULL, NULL, NULL, "MER_RR__2P_flags", NULL, "Level 2 classification and quality flags"}
};
...
static const struct BandDescriptor MER_FR__2P_IODD6_band_data[] = {
    ...
    {"l2_flags", "Flags.3", e_smod_3TOI, e_tid_ulong, -1, e_smid_non, NULL, NULL, NULL, "MER_RR__2P_flags_IODD6", NULL, "Level 2 classification and quality flags"}
};
