...
const struct DatasetDescriptorTable dddb_product_tables[46] = {
    ...
    {"SAR_APG_1P", "ASAR Alternating Polarization Ellipsoid Geocoded Image", 11, ASA_APG_1P_dataset_data},
    {"SAR_APM_1P", "ASAR Alternating Polarization Medium Resolution Image product", 10, ASA_APM_1P_dataset_data},
    {"SAR_APP_1P", "ASAR Alternating Polarization Mode Precision Image", 10, ASA_APP_1P_dataset_data},
    {"SAR_APS_1P", "ASAR Alternating Polarization Mode Single Look Complex", 8, ASA_APS_1P_dataset_data},
    {"SAR_AP__BP", "ASAR Alternating Polarization Browse Product", 5, ASA_AP__BP_dataset_data},
    {"SAR_IMG_1P", "ASAR Image Mode Ellipsoid Geocoded Image", 9, ASA_IMG_1P_dataset_data},
    {"SAR_IMM_1P", "ASAR Image Mode Medium Resolution Image", 8, ASA_IMM_1P_dataset_data},
    {"SAR_IMP_1P", "ASAR Image Mode Precision Image", 8, ASA_IMP_1P_dataset_data},
    {"SAR_IMS_1P", "ASAR Image Mode Single Look Complex", 6, ASA_IMS_1P_dataset_data},
    {"SAR_IM__BP", "ASAR Image Mode Browse Product", 3, ASA_IM__BP_dataset_data},
    {"SAR_WVI_1P", "ASAR Wave Mode SLC Imagette and Imagette Cross Spectra", 405, ASA_WVI_1P_dataset_data},
    {"SAR_WVS_1P", "ASAR Wave Mode Imagette Cross Spectra", 4, ASA_WVS_1P_dataset_data},
    {"SAR_WVW_2P", "ASAR Wave Mode Wave Spectra", 4, ASA_WVW_2P_dataset_data},
};
const struct BandDescriptorTable dddb_band_tables[37] = {
    ...
    {"SAR_APG_1P", "ASAR Alternating Polarization Geocoded Image", 6, ASA_APG_1P_band_data},
    {"SAR_APM_1P", "ASAR Alternating Polarization Medium Resolution Image", 6, ASA_APM_1P_band_data},
    {"SAR_APP_1P", "ASAR Alternating Polarization Precision Image", 6, ASA_APP_1P_band_data},
    {"SAR_APS_1P", "ASAR Alternating Polarization SLC Image", 6, ASA_APS_1P_band_data},
    {"SAR_AP__BP", "ASAR Alternatin Polarization Mode Browse Product", 5, ASA_AP__BP_band_data},
    {"SAR_IMG_1P", "ASAR Image Mode Geocoded Image", 5, ASA_IMG_1P_band_data},
    {"SAR_IMM_1P", "ASAR Image Mode Medium Resolution Image", 5, ASA_IMM_1P_band_data},
    {"SAR_IMP_1P", "ASAR Image Mode Precision Image", 5, ASA_IMP_1P_band_data},
    {"SAR_IMS_1P", "ASAR Image Mode SLC Image", 6, ASA_IMS_1P_band_data},
    {"SAR_IM__BP", "ASAR Image Mode Browse Product", 5, ASA_IM__BP_band_data},
};
